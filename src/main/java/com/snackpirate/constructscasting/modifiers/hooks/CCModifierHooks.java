...
public class CCModifierHooks {
    ...
    public static final ModuleHook<SpellHitModifierHook> SPELL_HIT = ModifierHooks.register(ConstructsCasting.id("spell_hit"), SpellHitModifierHook.class, SpellHitModifierHook.AllMerger::new, (a, b, c, d, e) -> {});
