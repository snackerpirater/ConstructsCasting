	...
	protected void addAllMaterials() {
		...
		buildMaterial(CCMaterials.leaf)
				...
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.build());
		buildMaterial(CCMaterials.amethyst)
				...
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.build());
		buildMaterial(CCMaterials.quartz)
				.statType(CCMaterialStats.Statless.ADORNMENT.getIdentifier())
				.fallbacks("crystal")
				.colorMapper(GreyToColorMapping.builderFromBlack()
		...
		buildMaterial(CCMaterials.earthslimeCrystal)
				...
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.addARGB(255, 0xFFfcfcfc)
						.build());
		buildMaterial(CCMaterials.skyslimeCrystal)
				.statType(CCMaterialStats.Statless.ADORNMENT.getIdentifier())
				.fallbacks("crystal")
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.addARGB(255, 0xFFfcfcfc)
						.build());
		buildMaterial(CCMaterials.enderslimeCrystal)
				.statType(CCMaterialStats.Statless.ADORNMENT.getIdentifier())
				.fallbacks("crystal")
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.build());
		buildMaterial(CCMaterials.ichorCrystal)
				.statType(CCMaterialStats.Statless.ADORNMENT.getIdentifier())
				.fallbacks("crystal")
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.addARGB(255, 0xFFfcfcfc)
						.build());
		buildMaterial(CCMaterials.permafrost)
				.statType(CCMaterialStats.Statless.ADORNMENT.getIdentifier())
				.fallbacks("crystal")
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.build());
		buildMaterial(CCMaterials.glowstone)
				.statType(CCMaterialStats.Statless.ADORNMENT.getIdentifier())
				.fallbacks("crystal")
				.colorMapper(GreyToColorMapping.builderFromBlack()
						...
						.build());
		buildMaterial(CCMaterials.echoShard)
				.statType(CCMaterialStats.Statless.ADORNMENT.getIdentifier())
				.fallbacks("crystal")
				.colorMapper(GreyToColorMapping.builderFromBlack()
