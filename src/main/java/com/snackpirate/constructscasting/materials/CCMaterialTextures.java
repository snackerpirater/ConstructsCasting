	...
	protected void addAllMaterials() {
		...
		buildMaterial(CCMaterials.arcanium).meleeHarvest().ranged().armor().maille().repairKit().statType(CCMaterialStats.Statless.ADORNMENT)
				...
				.transformer(GreyToSpriteTransformer.builderFromBlack()
						.addTexture( 63, arcaniumBorder,    0xFFD8D8D8)
						.addTexture(102, arcaniumBorder,    0xFFD8D8D8)
						.addTexture(140, arcaniumBase,      0xFFEEEEEE)
						.addTexture(178, arcaniumBase,      0xFFEEEEEE)
						.addTexture(216, arcaniumHighlight)
